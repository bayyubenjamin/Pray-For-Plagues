...
export default function UpgradePage() {
  return (
    <div className="max-w-xl mx-auto px-4 py-12">
      <SectionTitle title="LAB" subtitle="PHASE 3 · MUTATION · SEALED" />
      <PanelCard className="mt-10 flex flex-col items-center gap-6 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <p className="font-bangers text-5xl text-green text-aura tracking-widest">SEALED</p>
          <p className="mt-4 font-tech text-[11px] leading-relaxed text-gray">
            Mutation opens after Outbreak. Living vials raise dose, shift rarity, and rewrite purity / stability / potency.
          </p>
        </div>
        ...
        <Link href="/vault" className="font-tech text-[10px] tracking-widest text-green hover:text-green-bright">
          RETURN TO VAULT →
        </Link>
      </PanelCard>
    </div>
