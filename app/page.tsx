    ...
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 py-24">
        ...
        <ScrollReveal className="flex justify-center mt-12" delay={300}>
          <Link
            href="/inventory"
            className="text-green font-tech tracking-widest border-b border-green pb-1 hover:text-green-bright transition-colors"
          >
            VIEW ALL ANTIDOTES
          </Link>
        </ScrollReveal>
      ...
      <section className="w-full max-w-3xl mx-auto px-4 pb-24">
        <ScrollReveal>
          <SectionTitle title="WAITLIST" subtitle="GET EARLY ACCESS TO THE LAB." />
        </ScrollReveal>
        <ScrollReveal className="mt-10" delay={150}>
          <WaitlistForm />
        </ScrollReveal>
      </section>
    </div>
